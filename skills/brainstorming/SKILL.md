...
- **Architectural** — new projects, new subsystems, changes that
  ...
  design, written spec, then implementation via the normal development workflow.
...
8. **Transition to implementation** — proceed with the normal development workflow once the spec is approved
...
digraph brainstorming {
    ...
    "User reviews spec?" -> "Implement via normal workflow" [label="approved"];
}
```

**Terminal states are path-bound.** Architectural: after spec approval,
implementation proceeds through the normal development workflow — no
separate plan document or planning skill. Bounded: after approval,
...
- Proceed with implementation via the normal development workflow
- No separate implementation plan document is required — the approved spec is the guide
