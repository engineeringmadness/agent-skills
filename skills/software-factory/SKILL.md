...
9. For each phase 
  ...
  b. Use the `java-design` skill ONLY if you are working on a java codebase
  c. Run any tests to verify changes
  d. Add the branch to stack using `gh` CLI by involing the `gh-stack` skill
